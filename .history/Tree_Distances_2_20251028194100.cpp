...
*/
void dfs1(int u, int parent, vector<vector<int>> &adj, vector<int> &subtree, vector<long long> &dp)
{
...
*/
void dfs2(int u, int parent, vector<vector<int>> &adj, vector<int> &subtree, vector<long long> &dp, int n)
{
  for (int v : adj[u])
  {
    if (v == parent)
